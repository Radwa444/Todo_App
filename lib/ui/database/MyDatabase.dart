...
class MyDatabase {
  ...
  static Stream<QuerySnapshot<tasks>> getTask(String uID,int date) {
    return getTaskCollection(uID).where('SelectTime',isEqualTo: date).snapshots();
  }

  static Future<void> deleteTask(String uID, String idTask) {
    return getTaskCollection(uID).doc(idTask).delete();
  }
